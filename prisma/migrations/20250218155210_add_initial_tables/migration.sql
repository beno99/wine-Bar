-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARATION', 'FIMISHED');

-- CreateEnum
CREATE TYPE "OrderconsunptionMethod" AS ENUM ('TAKOFF', 'TAKWAY');
...
CREATE TABLE "Order" (
    ...
    "restaurantId" TEXT NOT NULL,
    "consunptionMethod" "OrderconsunptionMethod" NOT NULL,
    "createAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updateAt" TIMESTAMP(3) NOT NULL,
